...
/**
 * 这个类参考 Vuforia 给的 demo 中的 SampleApplicationSession类
 * This class handles the Vuforia Engine lifecycle
 * This class is used by all of the feature activities
 */
public class ARApplicationSession implements UpdateCallbackInterface
{
    ...
    private final WeakReference<ARApplicationControl> mSessionControlRef;
    ...
    private static final String key = "";
    ...
    public ARApplicationSession(ARApplicationControl sessionControl, int videoMode)
    {
        mSessionControlRef = new WeakReference<>(sessionControl);
    ...
    private static class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        private final WeakReference<ARApplicationSession> appSessionRef;

        InitVuforiaTask(ARApplicationSession session)
        {
        ...
        {
            ARApplicationSession session = appSessionRef.get();
            ...
            synchronized (session.mLifecycleLock)
            {
                ...
                Vuforia.setInitParameters(session.mActivityRef.get(), session.mVuforiaFlags, key);
    ...
    private static class ResumeVuforiaTask extends AsyncTask<Void, Void, Void>
    {
        ...
        ResumeVuforiaTask(ARApplicationSession session)
        {
            appSessionRef = new WeakReference<>(session);
        }
    ...
    private static class InitTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        InitTrackerTask(ARApplicationSession session)
        {
            appSessionRef = new WeakReference<>(session);
        }
    ...
    private static class LoadTrackerTask extends AsyncTask<Void, Void, Boolean>
    {
        ...
        LoadTrackerTask(ARApplicationSession session)
        {
            appSessionRef = new WeakReference<>(session);
        }
    ...
    private static class StartVuforiaTask extends AsyncTask<Void, Void, Boolean>
    {
        ...
        StartVuforiaTask(ARApplicationSession session)
        {
            appSessionRef = new WeakReference<>(session);
        }
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            ARApplicationControl sessionControl = appSessionRef.get().mSessionControlRef.get();

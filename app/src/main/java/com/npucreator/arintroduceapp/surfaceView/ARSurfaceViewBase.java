package com.npucreator.arintroduceapp.surfaceView;
...
/**
 * 这个类是渲染我们要显示小人的基础，相当于把相机拍摄到的画面与渲染的东西结合
 */
public class ARSurfaceViewBase extends GLSurfaceView
{
    private static final String TAG = "ARSurfaceViewBase";

    public ARSurfaceViewBase(Context context)
    {
        super(context);
    }

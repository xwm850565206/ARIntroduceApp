...
public class ARMessage
{
    ...
    public ARMessage(Context context, ViewGroup parentView, View placementReferenceView, boolean placeAboveView)
    {
        int FADE_IN_OUT_DURATION = 2000;

        mView = View.inflate(context, R.layout.app_message_view, null);

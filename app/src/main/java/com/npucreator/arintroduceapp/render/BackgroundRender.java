...
/**
 * 这个类是用来渲染摄像机拍摄到的画面的
 * 参考的是Vuforia 给的demo中的 SampleAppRender
 */
public class BackgroundRender
{
    private static final String LOGTAG = "BackgroundRender";

    private RenderingPrimitives mRenderingPrimitives = null;
    private final RenderControl mRenderingInterface;
    ...
    public BackgroundRender(RenderControl renderingInterface, Activity activity,
    ...
    {
        vbShaderProgramID = ARUtils.createProgramFromShaderSrc(VideoBackgroundShader.VB_VERTEX_SHADER,
